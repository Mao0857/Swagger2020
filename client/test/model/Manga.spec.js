...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Manga', function() {
      beforeEach(function() {
        instance = new Swaggerapi.Manga();
      });

      it('should create an instance of Manga', function() {
        // TODO: update the code to test Manga
        expect(instance).to.be.a(Swaggerapi.Manga);
      });
      ...
      it('should have the property chapters (base name: "chapters")', function() {
        // TODO: update the code to test the property chapters
        expect(instance).to.have.property('chapters');
        // expect(instance.chapters).to.be(expectedValueLiteral);
      });
